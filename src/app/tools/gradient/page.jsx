...
import ContentPageBlur from '@/components/tools/gradient/ContentPageBlur'
...
export default function Page() {
  const jsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: "Qu'est-ce que le Glassmorphism exactement ?",
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'Pourquoi le Glassmorphism est-il populaire ?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'Comment fonctionne le générateur de CSS Glassmorphism ?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'Est-ce que le Glassmorphism fonctionne sur tous les navigateurs ?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'Comment puis-je adapter le Glassmorphism à mon propre projet ?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'Le générateur de CSS Glassmorphism est-il gratuit ?',
        acceptedAnswer: {
          '@type': 'Answer',
